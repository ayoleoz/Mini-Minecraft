    ...
    ui(new Ui::MainWindow), cHelp()
{
    ...
    connect(ui->mygl, SIGNAL(sig_sendNumBedrock(int)), &inventoryWindow, SLOT(slot_setNumBedrock(int)));
    connect(ui->mygl, SIGNAL(sig_sendNumWater(int)), &inventoryWindow, SLOT(slot_setNumWater(int)));
    connect(ui->mygl, SIGNAL(sig_sendNumLava(int)), &inventoryWindow, SLOT(slot_setNumLava(int)));
...
void MainWindow::slot_inventoryWindow(bool openInventory) {
    if (openInventory) {
